...
number from this range that matches the least significant byte sent in the packet is \binary{4417}
...
Some \gls{aead} functions have limits for how many packets can be encrypted using the same keys.
