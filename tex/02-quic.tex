...
\begin{equation*}
  \begin{split}
    ...
    client\_secret & = \operatorname{HKDF-Expand-Label}(initial\_secret, \texttt{\dq{}client in\dq}, \texttt{\dq\dq}, 32) \\
    server\_secret & = \operatorname{HKDF-Expand-Label}(initial\_secret, \texttt{\dq{}server in\dq}, \texttt{\dq\dq}, 32) \\
  \end{split}
\end{equation*}
