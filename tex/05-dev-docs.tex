...
\todo{added spacing, and paragraph after the figure}
...
\begin{description}
    ...
    \ditem{\texttt{console}} Produces logs on the console output. This type of tracing has produces
...
\ditem{\texttt{qlog}} Produces traces which can be visualized by the
...
Both types of tracing incur noticeable overhead and should not be used in production environment.
