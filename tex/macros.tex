...
\newcommand{\genericClass}[2]{\texttt{\textcolor{codecolorclass}{#1}<{#2}>}}
\newcommand{\interface}[1]{{\color{codecolorinterface}\texttt{#1}}}
...
\newcommand{\ditemmethod}[4][\class]% [type typeset] type, name, args (types only)
  {\ditem{\ditemsrcsize\texttt{#1{#2} \method{#3}(\ditemmethodmakearglist{#4})}}}

\newcommand{\ditemmethodWithComment}[5][\class]% [type typeset] type, name, args (types only)
  {\ditemWithComment{\ditemsrcsize\texttt{#1{#2} \method{#3}(\ditemmethodmakearglist{#4})}}{#5}}
