...
% used VS like colors
% \usemintedstyle{vs}
% custom environment for our code listings
%
...
\lstnewenvironment{myListing}[2]{% [label, caption]
  \lstset{
    caption={#2},
    label={#1},
    language=[Sharp]C,
    ...
    types={Assert, Datagram, OneRttPacket, StreamFrame}
  }
}{%
}
...
\newcommand{\DisableActiveMigration}{\quicTransportParameter{disable\_\allowbreak{}active\_\allowbreak{}migration}}
