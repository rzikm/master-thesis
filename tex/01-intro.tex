...
transfer and implement it inside \dotnet{} runtime codebase. \todo{The API is already public, so
this part is out}

  \item Make the existing QUIC API public and allow switching between the new managed implementation
and the existing \libmsquic{} based one. \todo{Good point from ziki: this is not a goal, but a step.
maybe call this section Steps?}
