\chapter*{TODO: points for discussion}

\begin{itemize}

  \item glossary?, \todo{yes, it could be useful}
  \item list of abbreviations/acronyms... ? \todo{yes, useful}
  \item index? \todo{not necessary}
...
\begin{enumerate}
  ...
  \item Select a sufficient subset of QUIC specification needed to support the most basic data
    transfer and implement it inside \dotnet{} runtime codebase. \todo{The API is already public, so this part is out}
