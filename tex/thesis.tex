...
\usepackage{siunitx}        % thousands separators for large numbers in text
...
\usepackage{underscore}     % underscores which do not screw up hyphenation
\usepackage[toc,nopostdot,indexonlyfirst]{glossaries}     % lists of terms and abbreviations

%%% src: https://tex.stackexchange.com/questions/57353/how-to-get-caption-above-listing-with-minted
