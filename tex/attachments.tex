...
Attachments of the attachment archive:

\todo{License!?}
\todo{Do I need to prune the repo from all which is not mentioned in the text?}
...
\dirtree{%
  ...
  .2 {tex}\mydtcomment{\LaTeX{} source code for this document}.
  .3 {measurements}\mydtcomment{Raw CSV data with measurements presented in \autoref{chap:04-evaluation}}.
  .2 {README.md}\mydtcomment{\todo{adjust the readme file}}.
}
