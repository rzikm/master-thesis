...
\todo{DONE: mention that the app will only run if the SDK is available in the environment; also mention self-contained publish}
...
\todo{Quic.dll must be redeployed}
