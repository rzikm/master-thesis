...
downloaded from \url{https://github.com/dotnet/installer}. Download the ``Master (6.0.x Runtime)''
...
\subsection{Configuring the Development Environment}
...
This will produce the \libname{libcyrpto} and \libname{libssl} libraries in the \libopenssl{}
