...
\todo{path in the attachments}. \todo{creating a new ssl certificate using openssl cli? - could be, but is not necessary}

\todo{mention that we do not handle any errors in this simple example}
...
\begin{itemize}
  ...
  \todo{mention that the echo identifier is arbitrary, and briefly explain what ALPN is}
