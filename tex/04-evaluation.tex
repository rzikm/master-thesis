...
(client). Not applicable for \texttt{inproc} mode.
    ...
    \ditem{\texttt{-s, --streams}} The number of streams to create in each connection. Applicable
...
\begin{itemize}
  ...
  \litem{Managed client and \libmsquic{} server} With small number of connections, the two
...
packets.
  ...
  \litem{Managed server and \libmsquic{} client} The version of the \libmsquic{} library we used in
