...
\begin{itemize}
        ...
        fastest 99\% replies. \citeauthorfull{Tong2014} provides a great explanation on why
        measuring percentiles is more informative than average latency in one of his blog posts on
        elastic.co~\cite{Tong2014}. \todo{cite or deeply explain that this is a standard way of
        measuring it}
