...
namespace OpenSSLSandbox.Crypto
{
    public class Encoder
    {
        ...
        /// <returns></returns>
        public static int GetPacketNumberByteCount(ulong largestAckedPn, ulong currentPn)
        {
        ...
        /// <param name="pnLength">Length of the <see cref="truncatedPn"/> in bytes.</param>
        /// <returns></returns>
        public static ulong DecodePacketNumber(ulong largestAckedPn, ulong truncatedPn, int pnLength)
        {
