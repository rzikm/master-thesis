...
namespace System
{
    // just hacks to work around not being able to import strings resources from runtime repo
    internal partial class SR
    {
        /// <summary>The requested security protocol is not supported.</summary>
        private static string GetResourceString(string code, string message) => message;
