...
namespace System.Net.Quic.Public
{
    public sealed class QuicConnection : IDisposable
    {
        ...
        private QuicConnection(QuicImplementationProvider implementationProvider, IPEndPoint remoteEndPoint, SslClientAuthenticationOptions? sslClientAuthenticationOptions, IPEndPoint? localEndPoint = null)
        ...
        private QuicConnection(QuicImplementationProvider implementationProvider, QuicClientConnectionOptions options)
        {
            _provider = implementationProvider.CreateConnection(new Quic.QuicClientConnectionOptions()
            {
